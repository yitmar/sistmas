...
from .views import vista_login, vista_registro_participante, vista_registro_instructor, vista_loguot, vista_inicio, error404, myView,vista_validacion_usuario
...
urlpatterns=[
    ...
    path('vista_validacion_usuario', vista_validacion_usuario,name='vista_validacion_usuario'),
