    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correo_usuario', models.EmailField(max_length=254, validators=[django.core.validators.RegexValidator(message='solo se permiten correos hotmail.com o gmail.com', regex='^[a-zA-Z]*@hotmail.com|[a-zA-Z]*@gmail.com$')])),
                ...
                ('celuda_usuario', models.IntegerField(unique=True, validators=[django.core.validators.RegexValidator(message='solo se aceptas numeros', regex='^[0-9]{6,8}')])),
