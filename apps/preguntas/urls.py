...
from .views import lista_categorias, vista_lista_preguntas, vista_crear_preguntas, vista_eliminar_pregunta, vista_buscar_repuesta, vista_eliminar_repuesta, vista_crear_respuesta, vista_editar_pregunta, vista_editar_respuesta
...
urlpatterns=[
    ...
    path(r'editar_pregunta/(<pk>[0-9])', vista_editar_pregunta, name="editar_pregunta"),
    ...
    path(r'editar_respuesta/(<pk>[0-9])', vista_editar_respuesta, name="editar_respuesta"),
